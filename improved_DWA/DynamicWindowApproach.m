function [u,trajDB,xt_yu]=DynamicWindowApproach(x,model,goal,evalParam,ob,R)
%xt_yu为机器人向前运动后的预测位姿
...
% 评价函数的计算
[evalDB,trajDB,xt_all]=Evaluation_du2(x,Vr,goal,ob,R,model,evalParam);
 %  多考虑了一组动态障碍物距离
...
u=evalDB(ind,1:2)';
xt_yu=[xt_all(ind,1) xt_all(ind,2)];